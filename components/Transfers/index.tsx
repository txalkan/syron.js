        ...
        switch (logged_in?.address) {
                ...
                default:
                  {
                    ...
                    if (token_addr !== undefined) {
                      alert(
                        `You're about to submit a transaction to transfer ${input} ${currency} to ${user?.name}.${user?.domain} from your ZilPay EOA.`
                      );
                      await zilpay
                        .call({
          ...
          default: {
            ...
            if (donation !== null) {
              ...
              alert(
                `You're about to submit a transaction to transfer ${input} ${currency} to ${user?.name}.${user?.domain}. You're also donating ${donation} ZIL to donate.did, which gives you ${donation} xPoints!`
              );
              await zilpay
                .call({
