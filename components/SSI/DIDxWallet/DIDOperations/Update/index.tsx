                  ...
                  return (
                    <div>
                      {res[0] !== "DID services" && docType === "Key" ? (
                            ...
                            <div className={styles.actionBtnWrapper}>
                              {checkIsExist(res[0], 3) ? (
                                <button
                                  ...
                                  onClick={() => removeReplaceKeyList(res[0])}
                                >
                        ...
                        <>
                          {res[1].map(
                            (val: any[], i: React.Key | null | undefined) => (
                              <>
                                  ...
                                  <div className={styles.actionBtnWrapper}>
                                    {checkIsExist(val[0], 1) ? (
                                      <button
                                        className={styles.button2}
                                        onClick={() =>
                                          removeReplaceServiceList(val[0])
                                        }
                                      >
                                        <p className={styles.buttonText2}>
                                          to replace
          ...
          <div className={styles.docInfo}>
            ...
            >
              ...
              {replaceServiceList.length > 0 && (
                <>
                  <h4 style={{ marginTop: "7%" }}>Service IDs to replace:</h4>
              ...
              {deleteServiceList.length > 0 && (
                <>
                  <h4 style={{ marginTop: "7%" }}>Service IDs to delete:</h4>
              ...
              {services.length > 0 && (
                <>
                  <p style={{ marginTop: "7%" }}>Adding new services too!</p>
                  {services.map((val, i) => (
                    <p key={i} className={styles.didkey}>
                      - {val[0]}
                    </p>
