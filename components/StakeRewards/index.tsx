          ...
          {hideE2 && (
            <>
              {hideE1 ? (
                ...
                >
                  <p className={styles.buttonColorText}>{eLegend1}</p>
                </button>
              ) : (
                <>
                  <h3>
                    ...
                    >
                      <p className={styles.buttonText}>{eLegend1}</p>
                    </button>
                  </h3>
                </>
              )}
          ...
          {hideE1 && (
            <>
              {hideE2 ? (
                ...
                >
                  <p className={styles.buttonColorText}>{eLegend2}</p>
                </button>
              ) : (
                <>
                  <h3>
                    <span style={{ color: "yellow", marginRight: "3%" }}>
                      rewards <span style={{ color: "whitesmoke" }}>and</span>{" "}
                      withdrawals
                    </span>
                    <button
                      type="button"
                    ...
                    >
                      <p className={styles.buttonText}>{eLegend2}</p>
                    </button>
                  </h3>
                </>
              )}
