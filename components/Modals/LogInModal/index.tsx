                          ...
                          <div className={styles.addrWrapper}>
                            {loggedIn.username ? (
                              ...
                              <p className={styles.addrSsi}>
                                <a
                                  className={styles.x}
                                  href={`https://viewblock.io/zilliqa/address/${loggedIn?.address}?network=${net}`}
                                  rel="noreferrer"
                                  target="_blank"
                                >
                                  <span className={styles.x}>
                                    {zcrypto.toBech32Address(loggedIn.address!)}
                                  </span>
                                </a>
                              </p>
                            )}
