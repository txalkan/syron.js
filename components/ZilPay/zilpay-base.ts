      ...
      const code =
        ...
        (* v6.2.0
          ...
          contract DIDxWALLET(
            ...
            field version: String = "DIDxWALLET_6.2.0" (* @xalkan *)
          ...
          transition UpdateNftDid(
            ...
            is_free = builtin eq id free; match is_free with
              | True => | False =>
                  txID = "UpdateNftDid";
                  init_did <-& current_init.implementation;
                  get_fee <-& init_did.utility[id][txID]; fee = option_uint128_value get_fee;
                  FetchServiceAddr id; get_addr <- services[id]; coin_addr = option_bystr20_value get_addr;
                  IncreaseAllowance coin_addr init_did fee end;
            ...
            is_null = builtin eq empty_string id; match is_null with
              ...
              | False =>
                ...
                zil_amount = match is_zil with
                  | True => fee
                  | False => zero end;
                msg = let m = { _tag: "Mint"; _recipient: token_addr; _amount: zil_amount;
                  to: to;
                  token_uri: token_uri;
