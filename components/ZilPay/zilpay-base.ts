      ...
      const code =
        ...
        (* v5.5.0
          ...
          procedure ThrowIfNoKey( optKey: Option ByStr33 )
            match optKey with
            | Some key =>
            | None => e = { _exception : "DIDxWallet-UndefinedKey" }; throw e end end
          ...
          procedure VerifyUpdateKey( didUpdate: ByStr33 )
            ...
            | True => e = { _exception : "DIDxWallet-SameKey" }; throw e
            | False => end end
          ...
          transition DidDeactivate(
            ...
            did := null; controller := zeroByStr20; did_hash := zeroByStr; deadline := zero;
            verification_methods := empty_methods; dkms := empty_dkms;
            services := empty_services; services_ := empty_services_;
