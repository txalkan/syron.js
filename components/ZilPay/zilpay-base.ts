  ...
  async deploySsiDapp(net: string, address: string) {
    try {
      ...
      (* SSI DNS v0.6
        ...
        field version: String = "SSIDNS_0.6.0" (* @xalkan *)
  ...
  async deploySsiDns(net: string, address: string) {
    try {
      ...
      (* SSI DNS v0.7
        ...
        *)  
      `;
      const init_nft = '0xa6839868185028d3a0fdb1990de911403189e7747decd872f3916a09b97b7285'
      const init_dns = []
      const init = [
        {
          vname: "_scilla_version",
        ...
        },
        {
          vname: "name",
          type: "String", //@xalkan
          value: "zlp.ssi dApp: .zlp NFT domain names",
        },
        {
          vname: "symbol",
          type: "String",
