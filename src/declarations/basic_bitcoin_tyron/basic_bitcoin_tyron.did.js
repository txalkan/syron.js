export const idlFactory = ({ IDL }) => {
  ...
  const UpdateBalanceError = IDL.Variant({
    ...
    'CallError' : IDL.Record({ 'method' : IDL.Text, 'reason' : IDL.Text }),
