...
function Component() {
    ...
    const handleOnChange = (event: { target: { value: any } }) => {
        setError('');
        setInput(''), setLegend('save');
        setButton('button primary');
        setName(''), setLegend2('save');
        ...
        if (contract !== null) {
            switch (account) {
                case 'zilpay':
                    {
                        ...
                        alert(
                            'From a ZilPay account, the order takes 2 transactions.'
                        );
                        const paramsA = [];
                        const spender = {
                            vname: 'spender',
                ...
                case 'xwallet':
                    {
                        alert(
                            `You're about to transfer the ${user?.nft} NFT Username.`
                        );
            ...
            {txID === '' && (
                <>
                    <h4 style={{ marginBottom: '6%' }}>
                        Transfer{' '}
                        <span className={styles.username}>{user?.nft}</span> NFT
                        Username
                    </h4>
                    <div className={styles.container}>
                        <select onChange={handleOnChange}>
                            ...
                            <option value="xwallet">
                                This Tyron self-sovereign account
                            </option>
                            <option value="another">
                                Another Tyron self-sovereign account
                            </option>
                            <option value="zilpay">
