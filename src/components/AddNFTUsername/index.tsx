    ...
    return (
        <div style={{ marginTop: '10%' }}>
            <h2 style={{ textAlign: 'center', color: 'grey' }}>
                Deploy <strong>DID<i style={{ textTransform: 'lowercase' }}>x</i>Wallet</strong> <span style={{ textTransform: 'lowercase' }}>for</span> <strong style={{ color: 'yellow' }}>{username?.nft}.{username?.domain}</strong>
            </h2>
            <input
                type="button"
