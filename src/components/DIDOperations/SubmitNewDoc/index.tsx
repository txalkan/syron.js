...
function Component({
    ...
    const handleSubmit = async () => {
        ...
        if (arConnect === null) {
            ...
            alert(
                `You're about to submit a DID Create transaction. You're also donating ${donation} ZIL to the SSI Protocol.`
            );
            ...
            {donation !== null && (
                <div style={{ marginTop: '10%' }}>
                    <button className={styles.button} onClick={handleSubmit}>
                        create <span style={{ color: 'yellow' }}>did</span>
                    </button>
                    <p className={styles.gascost}>Gas cost: around 7 ZIL</p>
                </div>
            )}
        </>
    );
