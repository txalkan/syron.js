...
const TravelRule: React.FC = () => {
    ...
    return (
        <>
            <div>
                <h4 className="major">
                    Generate your Travel Rule SSI Passport{' '}
                </h4>
                <p style={{ width: '100%' }}>
                    Create an{' '}
                    ...
                    for KYC to make your digital identity compliant with the
                    FATF Travel Rule to counteract money laundering and
                    terrorism financing, and thus building a web of trust. This
                    personal information will get encrypted by your SSI Travel
                    Rule Key generated by your permawallet - only you decide who
                    can read this message. You won&apos;t need to give this
                    information anymore to third parties, over and over again.
                    Your SSI Travel Rule - private - Key will get encrypted by
                    your SSI Permawallet Key and saved into your wallet, so only
                    you can access it. When making a transfer, you will have the
                    option to attach this secret encrypted by the
                    beneficiary&apos;s SSI Communication Key so they can read
                        ...
                        <li>
                            <input
                                ...
                                onClick={() => {
                                    ...
                                    setLegendButton('Saved');
                                    setExecuteButton('button');
                                    dispatch(
                                        actionsCreator.setTravelRule(ivms101)
                                    );
                                }}
                            />
                        </li>
